...
```{r}
title <- str_replace(name1, "^\\d+\\.", "")
title
```


```{r}
year = page %>% html_nodes(".sc-6ade9358-7.exckou.cli-title-metadata-item") %>% html_text()
...
```{r}
episode <- page %>% html_nodes(".sc-6ade9358-7.exckou.cli-title-metadata-item") %>%
html_text()
